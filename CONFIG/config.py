...
class Config(object):
    ...
    BOT_NAME = "tg-ytdlp-robot"
    # A name for users - Required (str)
    BOT_NAME_FOR_USERS = "ornamental_hermit_bot" #name in database
    ...
    SUBSCRIBE_CHANNEL_URL = "https://t.me/ermita_ornatus"
    REQUIRED_CHANNEL_MENTION = "@ermita_ornatus"
    ...
    HIDE_CREDITS_MSG = True
    # If True, do not append the "Video URL" link in captions.
    HIDE_CAPTION_VIDEO_URL_LINK_MSG = True
    # If True, the title in captions will be the video URL link.
    MAKE_TITLE_BE_VIDEO_URL_LINK = True
